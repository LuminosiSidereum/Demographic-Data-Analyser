...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = (higher_education.salary[higher_education.salary==">50K"].count()/higher_education.salary.count()*100).round(1)
    lower_education_rich = (lower_education.salary[lower_education.salary==">50K"].count()/lower_education.salary.count()*100).round(1)
    ...
    rich_percentage = (df.salary[(df["hours-per-week"]==1) & (df["salary"]==">50K")].count()/num_min_workers*100).round(1)
